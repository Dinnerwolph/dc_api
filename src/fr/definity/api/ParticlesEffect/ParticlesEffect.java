package fr.definity.api.ParticlesEffect;
...
public enum ParticlesEffect {
  ...
  private static final Map<String, ParticlesEffect> 		NAME_MAP;
  private static final Map<Integer, ParticlesEffect> 		ID_MAP;
  ...
  static { 
	  NAME_MAP 	= new HashMap<String, ParticlesEffect>();
	  ID_MAP 	= new HashMap<Integer, ParticlesEffect>();

	  for (ParticlesEffect effect : values()) {
		  NAME_MAP.put(effect.name, effect);
		  ID_MAP.put(Integer.valueOf(effect.id), effect);
	  }
  }

  private ParticlesEffect(String name, int id, int requiredVersion, ParticleProperty[] properties) {
	  this.name 			= name;
	  this.id 				= id;
  ...
  public static ParticlesEffect fromName(String name) {
	  for (Map.Entry entry : NAME_MAP.entrySet()) {
		  if (((String)entry.getKey()).equalsIgnoreCase(name)) {
			  return (ParticlesEffect)entry.getValue();
		  }
	  }
  ...
  @SuppressWarnings("rawtypes")
  public static ParticlesEffect fromId(int id) {
  ...
  private static boolean isDataCorrect(ParticlesEffect effect, ParticleData data)
  {
    return ((effect == BLOCK_CRACK) || (effect == BLOCK_DUST)) && (((data instanceof BlockData)) || ((effect == ITEM_CRACK) && ((data instanceof ItemData))));
  }

  private static boolean isColorCorrect(ParticlesEffect effect, ParticleColor color)
  {
  ...
  public void display(float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center, double range)
    throws ParticlesEffect.ParticleVersionException, ParticlesEffect.ParticleDataException, IllegalArgumentException
  {
    if (!isSupported())
    {
  ...
  public void display(ParticleColor color, Location center, double range)
    throws ParticlesEffect.ParticleVersionException, ParticlesEffect.ParticleColorException
  {
    if (!isSupported())
    {
      throw new ParticleVersionException("This particle effect is not supported by your server version");
  ...
  public void display(Location location, int range)
  {
    display(0.0F, 0.0F, 0.0F, 1.0F, 1, location, range);
  }
  ...
  public void display(ParticleData data, float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center, double range)
    throws ParticlesEffect.ParticleVersionException, ParticlesEffect.ParticleDataException
  {
    if (!isSupported())
    {
      throw new ParticleVersionException("This particle effect is not supported by your server version");
  ...
  public static final class BlockData extends ParticlesEffect.ParticleData
  {
  ...
  public static final class ItemData extends ParticlesEffect.ParticleData
  {
  ...
  public static final class NoteColor extends ParticlesEffect.ParticleColor
  {
  ...
  public static final class OrdinaryColor extends ParticlesEffect.ParticleColor
  {
  ...
  public static final class ParticlePacket
  {
    ...
    private final ParticlesEffect effect;
    ...
    private final ParticlesEffect.ParticleData data;
    private Object packet;

    public ParticlePacket(ParticlesEffect effect, float offsetX, float offsetY, float offsetZ, float speed, int amount, boolean longDistance, ParticlesEffect.ParticleData data)
      throws IllegalArgumentException
    {
      initialize();
      if (speed < 0.0F)
    ...
    public ParticlePacket(ParticlesEffect effect, Vector direction, float speed, boolean longDistance, ParticlesEffect.ParticleData data)
      throws IllegalArgumentException
    {
      this(effect, (float)direction.getX(), (float)direction.getY(), (float)direction.getZ(), speed, 0, longDistance, data);
    }

    public ParticlePacket(ParticlesEffect effect, ParticlesEffect.ParticleColor color, boolean longDistance)
    {
      this(effect, color.getValueX(), color.getValueY(), color.getValueZ(), 1.0F, 0, longDistance, null);
      if ((effect == ParticlesEffect.REDSTONE) && ((color instanceof ParticlesEffect.OrdinaryColor)) && (((ParticlesEffect.OrdinaryColor)color).getRed() == 0))
      {
	...
	public static void initialize()
      throws ParticlesEffect.ParticlePacket.VersionIncompatibleException
    {
      if (initialized)
      {
        return;
      ...
      {
        throw new VersionIncompatibleException("Your current api version seems to be incompatible with this library", exception);
      }
      initialized = true;
    }
    ...
    private void initializePacket(Location center)
      throws ParticlesEffect.ParticlePacket.PacketInstantiationException
    {
      if (this.packet != null)
      {
        return;
        ...
        else
        {
          ...
          if (this.data != null)
          {
            ...
            ReflectionUtils.setValue(this.packet, true, "k", 
              new int[] { (int) (this.effect == ParticlesEffect.ITEM_CRACK ? packetData : 
    ...
    public void sendTo(Location center, Player player)
      throws ParticlesEffect.ParticlePacket.PacketInstantiationException, ParticlesEffect.ParticlePacket.PacketSendingException
    {
